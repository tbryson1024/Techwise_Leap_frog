...
while running:
    ...
    if player.on_log:
        player.speed = log.speed




    # jason code - let's see if this works frog on top of log. YES
    # sprite_group.update()

    # if pygame.sprite.collide_mask(player, log1):
    #     player.on_log = True
    #     player.rect.y = log1.rect.y
